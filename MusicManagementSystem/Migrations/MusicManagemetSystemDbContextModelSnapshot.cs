...
namespace MusicManagementSystem.Migrations
{
    ...
    partial class MusicManagemetSystemDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicManagementSystem.Models.SongsImagesPaths", b =>
                {
                    ...
                    b.Property<int>("ImagesPathsId")
                        .HasColumnType("int");

                    b.HasKey("SongId", "ImagePathId");

                    b.HasIndex("ImagesPathsId");
            ...
            modelBuilder.Entity("MusicManagementSystem.Models.SongsImagesPaths", b =>
                {
                    b.HasOne("MusicManagementSystem.Models.ImagesPaths", "ImagesPaths")
                        .WithMany()
                        .HasForeignKey("ImagesPathsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
